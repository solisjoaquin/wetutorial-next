export const Steps = () => {
    return (<div className="pt-24 pb-24 sm:pb-28 mx-auto px-8 max-w-7xl">

        <div className=" text-center">
            <h3 className="text-2xl font-bold leading-7 text-gray-900 pb-8 sm:pb-12 sm:text-3xl dark:text-white">Life cicle of a study group</h3>
